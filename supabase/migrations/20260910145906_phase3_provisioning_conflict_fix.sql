-- Qualify the unique conflict target through its constraint because the
-- function's output column is also named profile_id.
...
begin
  ...
  on conflict on constraint psychiatrists_profile_id_key do update
