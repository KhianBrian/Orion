-- Phase 18.5 correction: keep the database timestamp typed as timestamptz.
...
begin
  ...
  select * into session_row from public.video_sessions where appointment_id = target_appointment_id for update;
