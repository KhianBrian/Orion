...
| [R1.4 — Google Meet integration](google-meet-owner-decision-brief.md) | Plan provider configuration, per-appointment meetings, access controls, timing, and outage handling. | Owner decision brief prepared; mapped to Phase 18 and still blocked on Phase 17, Workspace, and vendor approval |
