...
| [R1.4 — Google Meet integration](google-meet-owner-decision-brief.md) | Provider configuration, per-appointment meetings, access controls, timing, and outage handling. | Phase 18 implementation complete and verified; real-user activation remains separately gated by production Google, privacy/vendor, clinical, security, operations, and release approval |
