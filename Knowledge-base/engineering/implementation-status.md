...
| [Phase 5 — Video](phases/phase-5-video.md) | Blocked | The separate D5 work package provides synthetic JaaS admission; no production integration exists. | Phase 18's Google Meet implementation is complete; approve production Google Meet and Q9 vendor/data-transfer terms before real-user activation. |
