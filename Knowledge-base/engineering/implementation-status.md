...
| [Phase 15 / R1.1 — Data, consent, and audit foundation](phases/phase-15-data-consent-and-audit-foundation.md) | Implemented — branch `codex/phase-15-data-consent-audit` | Provider-neutral foundation plus patient/psychiatrist requester support, admin replies, and unread indicators are locally verified. See the [Phase 15 as-built audit](../audit-trail/20260913-phase-15-data-consent-audit.md); merge, remote apply/deploy, and policy gates remain separate. |
