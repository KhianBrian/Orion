...
| [Phase 15 / R1.1 — Data, consent, and audit foundation](phases/phase-15-data-consent-and-audit-foundation.md) | Planned — implementation blocked | Consume the Phase 14 as-built audit, then re-query live state and resolve the named data, role, retention, and consent decisions before implementation. |
