...
| D5 — Demo video boundary | Planned | JaaS is selected for the labelled synthetic-only demo; no participant-admission path exists yet. | Implement the [JaaS demo video plan](phases/d5-jaas-demo-video.md); real-launch video remains blocked. |
