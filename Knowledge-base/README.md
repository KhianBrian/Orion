...
| [Phase packets](engineering/phase-packets/README.md) | The single living current-state and handoff record for an active or recently changed phase. | Resuming or handing off a phase. |
