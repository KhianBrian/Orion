...
export const ROLE_NAVIGATION = Object.freeze({
  ...
  [APP_ROLES.PSYCHIATRIST]: [{ label: "My appointments", path: ROUTES.APPOINTMENTS, subject: SUBJECTS.APPOINTMENTS }, { label: "My schedule", path: ROUTES.SCHEDULE, subject: SUBJECTS.SCHEDULE }],
  [APP_ROLES.ADMIN]: [
