    ...
    <div className="home-page">
      <div className="home-hero">
        <div className="hero-text-center">
          ...
          <p className="hero-subtitle">Orion helps approved accounts book and manage synthetic demo psychiatry appointments.</p>
          <ButtonLink to={status === "signedIn" ? "/app" : "/login"}>{status === "signedIn" ? "Go to your account" : "Sign in to the demo"}</ButtonLink>
        </div>
      </div>
