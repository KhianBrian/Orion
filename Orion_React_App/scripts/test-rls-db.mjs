...
const credentials = [
  ["patient.one@demo.orion.invalid", process.env.DEMO_PATIENT_ONE_PASSWORD],
  ["patient.two@demo.orion.invalid", process.env.DEMO_PATIENT_TWO_PASSWORD],
  ["psychiatrist.one@demo.orion.invalid", process.env.DEMO_PSYCHIATRIST_ONE_PASSWORD],
  ["psychiatrist.two@demo.orion.invalid", process.env.DEMO_PSYCHIATRIST_TWO_PASSWORD],
  ["admin@demo.orion.invalid", process.env.DEMO_ADMIN_PASSWORD],
];
...
try {
  ...
  console.log("Database RLS checks passed: appointment relationship allow/deny and protected role denial.");
} finally {
  if (appointmentId) {
